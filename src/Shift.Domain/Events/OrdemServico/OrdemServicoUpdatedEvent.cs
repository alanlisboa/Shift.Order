...
{
    public class OrdemServicoUpdatedEvent : Event
    {
        public OrdemServicoUpdatedEvent(Guid id, int numero, DateTime data, Guid pacienteId, Guid convenioId, Guid postoId, Guid medicoId)
        {
            Id = id;
            Numero = numero;
            DataOrdem = data;
